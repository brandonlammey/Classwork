...
class StackInterface
{
	...
	//Example: If you push 5, push 10, and push 15 note that the the vector will have 15 as it's
	//first value. In other words, the front of the vector represents the top of the stack
